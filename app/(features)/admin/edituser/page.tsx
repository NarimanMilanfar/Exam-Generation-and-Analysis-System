...
function EditUserContent() {
  ...
  // Get user data from URL params or mock data
  useEffect(() => {
    ...
    if (userId) {
      // Set initial data from URL params for immediate display (without image)
      if (userName && userEmail && userRole) {
        ...
        setImagePreview(''); // Will be set by database fetch
      }

      // Fetch actual user data from database to get current image and data
  ...
  const fetchUserData = async (userId: string) => {
    try {
      ...
      if (response.ok) {
        ...
        // Keep the URL param data if API fails
      }
    } catch (error) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Also emit profile update event in case the current user updated their own profile
        ...
        // Redirect back to users page - the users page will automatically update
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                <Image
                  ...
                  className="w-8 h-8"
                />
                <h1 className="text-white text-lg font-semibold">Edit User</h1>
              </div>
              ...
              <div className="flex-1 max-w-md ml-8">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="search ..."
                    className="w-full pl-10 pr-4 py-2 rounded-full bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <nav className="flex mb-6" aria-label="Breadcrumb">
              <ol className="inline-flex items-center space-x-1 md:space-x-3">
                <li className="inline-flex items-center">
                  <a href="/admin/users" className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                ...
                <li>
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit User</span>
                  </div>
                </li>
              </ol>
            </nav>
            ...
            <div className="bg-white rounded-lg shadow-lg border">
              <div className="px-6 py-4 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-600 mt-1">Update user details and permissions</p>
              </div>
              ...
              <div className="p-6">
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Select the appropriate role for this user's permissions
                    </p>
                  </div>
